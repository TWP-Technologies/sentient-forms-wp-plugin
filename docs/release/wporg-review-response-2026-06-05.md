...
- `https://sentientforms.com` returned HTTP 200.
- `https://github.com/TWP-Technologies/sentient-forms-wp-plugin` returned HTTP 200.
- `readme.txt` now states that Sentient Forms is an official TWP Technologies, LLC product and links the product site, author site, and public development repository.
