 ...
 * (e.g., wp-content/plugins/your-plugin-name/build/generate-class-map.php)
 * 2. Ensure SENTIENT_FORMS_PLUGIN_DIR_FOR_BUILD is correctly defined below.
 * 3. Run from the command line: php build/generate-class-map.php
 *
...
else
{
    ksort( $class_map );
    $output_content = "<?php\n";
    $output_content .= "// Sentient Forms Class Map - Auto-generated by build/generate-class-map.php\n";
