...
Playwright tests interact with the Dockerized WordPress stack (`docker compose up -d` from the repo root). Before running `bun run e2e` or `bun run qa:full`, ensure:
